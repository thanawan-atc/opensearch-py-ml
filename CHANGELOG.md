...
- Update model upload history -  sentence-transformers/all-MiniLM-L6-v2 (v.1.0.1)(TORCH_SCRIPT) by @thanawan-atc ([#136](https://github.com/thanawan-atc/opensearch-py-ml/pull/136))
