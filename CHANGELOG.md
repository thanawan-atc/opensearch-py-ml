...
- Update model upload history -  sentence-transformers/all-MiniLM-L12-v2 (v.2.0.0)(TORCH_SCRIPT) by @thanawan-atc ([#152](https://github.com/thanawan-atc/opensearch-py-ml/pull/152))
