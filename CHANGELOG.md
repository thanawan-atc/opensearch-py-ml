...
- Update model upload history -  sentence-transformers/all-MiniLM-L12-v2 (v.2.0.0)(BOTH) by @thanawan-atc ([#98](https://github.com/thanawan-atc/opensearch-py-ml/pull/98))
