...
- Update model upload history -  sentence-transformers/all-MiniLM-L6-v2 (v.1.1.1)(ONNX) by @thanawan-atc ([#87](https://github.com/thanawan-atc/opensearch-py-ml/pull/87))
