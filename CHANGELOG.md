...
- Update model upload history -  sentence-transformers/xlm-r-bert-base-nli-mean-tokens (v.1.0.1)(BOTH) by @thanawan-atc ([#103](https://github.com/thanawan-atc/opensearch-py-ml/pull/103))
