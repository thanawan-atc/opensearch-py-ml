...
- Update model upload history -  sentence-transformers/multi-qa-mpnet-base-dot-v1 (v.1.0.1)(TORCH_SCRIPT) by @thanawan-atc ([#91](https://github.com/thanawan-atc/opensearch-py-ml/pull/91))
