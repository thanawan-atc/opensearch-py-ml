...
- Update pretrained_model_listing.json (2023-08-23 19:04:57) by @thanawan-atc ([#221](https://github.com/thanawan-atc/opensearch-py-ml/pull/221))
...
- Update model upload history -  sentence-transformers/xlm-r-bert-base-nli-mean-tokens (v.2.0.1)(TORCH_SCRIPT) by @thanawan-atc ([#229](https://github.com/thanawan-atc/opensearch-py-ml/pull/229))
