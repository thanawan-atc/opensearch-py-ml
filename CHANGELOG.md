...
- Update model upload history -  sentence-transformers/all-MiniLM-L12-v2 (v.1.0.1)(ONNX) by @thanawan-atc ([#132](https://github.com/thanawan-atc/opensearch-py-ml/pull/132))
