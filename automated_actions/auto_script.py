...
def trace_sentence_transformer_model(model_id, embedding_dimension, pooling_mode, model_format):
...
def verify_embedding_data(torch_embedding_data, onnx_embedding_data):
    ...
    print(f"{TORCH_SCRIPT_FORMAT} embeddings matches {ONNX_FORMAT} embeddings")
...
def main(args):
    ...
    torchscript_model_path, torchscript_model_config_path = trace_sentence_transformer_model(
        args.model_id, args.embedding_dimension, args.pooling_mode, TORCH_SCRIPT_FORMAT
    )
    ...
    onnx_model_path, onnx_model_config_path = trace_sentence_transformer_model(
        args.model_id, args.embedding_dimension, args.pooling_mode, ONNX_FORMAT
    )
